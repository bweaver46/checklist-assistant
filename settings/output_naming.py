...
def resolve_unique_output_name(name: str, directory: str = ".") -> str:
...
def raw_export_path(name: str, directory: str = ".") -> str:
    return os.path.abspath(os.path.join(directory, name + RAW_SUFFIX))


def final_export_path(name: str, directory: str = ".") -> str:
